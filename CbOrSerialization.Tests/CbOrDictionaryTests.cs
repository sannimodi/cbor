...
public class CbOrDictionaryTests
{
    ...
    public void Serialize_DictionaryStringToString_ReturnsValidCborData()
    {
        ...
        // Act
        var result = CbOrSerializer.Serialize(model, _context.DictionaryModel);
    ...
    public void Serialize_DictionaryStringToInt_ReturnsValidCborData()
    {
        ...
        // Act
        var result = CbOrSerializer.Serialize(dictionary, _context.DictionaryOfStringAndInt32);
    ...
    public void Deserialize_DictionaryStringToString_ReturnsCorrectData()
    {
        ...
        var cborData = CbOrSerializer.Serialize(original, _context.DictionaryOfStringAndString);

        // Act
        var deserialized = CbOrSerializer.Deserialize(cborData, _context.DictionaryOfStringAndString);
    ...
    public void RoundTrip_DictionaryModel_PreservesAllData()
    {
        ...
        var cborData = CbOrSerializer.Serialize(original, _context.DictionaryModel);

        // Act
        var deserialized = CbOrSerializer.Deserialize(cborData, _context.DictionaryModel);
    ...
    public void Serialize_EmptyDictionary_ReturnsValidCborData()
    {
        ...
        // Act
        var result = CbOrSerializer.Serialize(emptyDict, _context.DictionaryOfStringAndString);
    ...
    public void Deserialize_EmptyDictionary_ReturnsEmptyDictionary()
    {
        ...
        var cborData = CbOrSerializer.Serialize(emptyDict, _context.DictionaryOfStringAndInt32);

        // Act
        var deserialized = CbOrSerializer.Deserialize(cborData, _context.DictionaryOfStringAndInt32);
    ...
    public void Serialize_NullableDictionaryWithValue_ReturnsValidCborData()
    {
        ...
        // Act
        var result = CbOrSerializer.Serialize(model, _context.NullableDictionaryModel);
    ...
    public void RoundTrip_NullableDictionaryModel_PreservesNullValues()
    {
        ...
        var cborData = CbOrSerializer.Serialize(original, _context.NullableDictionaryModel);

        // Act
        var deserialized = CbOrSerializer.Deserialize(cborData, _context.NullableDictionaryModel);
    ...
    public void Serialize_ComplexDictionaryModel_ReturnsValidCborData()
    {
        ...
        // Act
        var result = CbOrSerializer.Serialize(model, _context.ComplexDictionaryModel);
    ...
    public void RoundTrip_ComplexDictionaryModel_PreservesAllData()
    {
        ...
        var cborData = CbOrSerializer.Serialize(original, _context.ComplexDictionaryModel);

        // Act
        var deserialized = CbOrSerializer.Deserialize(cborData, _context.ComplexDictionaryModel);
    ...
    public void RoundTrip_DictionaryWithDifferentSizes_WorksCorrectly(int size)
    {
        ...
        var cborData = CbOrSerializer.Serialize(dictionary, _context.DictionaryOfStringAndInt32);
