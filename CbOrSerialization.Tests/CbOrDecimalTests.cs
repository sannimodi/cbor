...
public class CbOrDecimalTests
{
    ...
    public void Serialize_DecimalModel_WithValidDecimal_SerializesCorrectly()
    {
        ...
        // Act
        var serialized = CbOrSerializer.Serialize(model, _context.DecimalModel);
    ...
    public void Serialize_Then_Deserialize_DecimalModel_RoundTripSucceeds()
    {
        ...
        // Act
        var serialized = CbOrSerializer.Serialize(original, _context.DecimalModel);
        var deserialized = CbOrSerializer.Deserialize(serialized, _context.DecimalModel);
