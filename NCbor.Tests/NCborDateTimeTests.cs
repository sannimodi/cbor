...
public class NCborDateTimeTests
{
    ...
    public void Serialize_DateTimeModel_WithUtcDateTime_SerializesCorrectly()
    {
        ...
        // Act
        var serialized = NCborSerializer.Serialize(model, _context.DateTimeModel);
    ...
    public void Serialize_Then_Deserialize_DateTimeModel_RoundTripSucceeds()
    {
        ...
        // Act
        var serialized = NCborSerializer.Serialize(original, _context.DateTimeModel);
        var deserialized = NCborSerializer.Deserialize(serialized, _context.DateTimeModel);
    ...
    [Fact]
    public void Deserialize_CorruptedDateTimeData_ThrowsNCborDeserializationException()
    {
        ...
        var validSerialized = NCborSerializer.Serialize(model, _context.DateTimeModel);
        
        // Corrupt the data by truncating it
        var corruptedData = validSerialized.Take(validSerialized.Length / 2).ToArray();

        // Act & Assert
        var act = () => NCborSerializer.Deserialize(corruptedData, _context.DateTimeModel);
