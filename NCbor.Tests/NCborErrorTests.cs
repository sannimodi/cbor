...
public class NCborErrorTests
{
    ...
    [Fact]
    public void Deserialize_EmptyData_ThrowsNCborValidationException()
    {
        // Arrange
    ...
    [Fact]
    public void Deserialize_InvalidNCborData_ThrowsNCborDeserializationException()
    {
        // Arrange
    ...
    [Fact]
    public void Deserialize_PartialNCborData_ThrowsException()
    {
        // Arrange
        var partialData = new byte[] { 0xA1 }; // Start of map but incomplete

        // Act & Assert
        var act = () => NCborSerializer.Deserialize(partialData, _context.SimpleModel);
        act.Should().Throw<Exception>();
    }

    [Fact]
    public void Deserialize_WrongNCborType_ThrowsException()
    {
        // Arrange
        var stringData = new byte[] { 0x64, 0x74, 0x65, 0x73, 0x74 }; // CBOR string "test"

        // Act & Assert
        var act = () => NCborSerializer.Deserialize(stringData, _context.SimpleModel);
        act.Should().Throw<Exception>();
    }
    ...
    public void Serialize_VeryLargeObject_DoesNotThrow()
    {
        ...
        var act = () => NCborSerializer.Serialize(largeList, _context.ListOfSimpleModel);
        act.Should().NotThrow();
    ...
    public void Serialize_EdgeCaseIntegers_HandlesCorrectly(int value)
    {
        ...
        // Act
        var serialized = NCborSerializer.Serialize(model, _context.SimpleModel);
