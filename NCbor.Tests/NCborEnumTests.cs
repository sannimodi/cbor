...
public class NCborEnumTests
{
    ...
    public void SerializeEnumModel_ShouldSucceed()
    {
        ...
        // Act
        var bytes = NCborSerializer.Serialize(model, _context.EnumModel);
        var deserialized = NCborSerializer.Deserialize(bytes, _context.EnumModel);
