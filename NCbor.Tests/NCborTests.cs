...
public class NCborTests
{
    ...
    public void Serialize_SimpleModel_ReturnsValidCborData()
    {
        ...
        // Act
        var result = NCborSerializer.Serialize(model, _context.SimpleModel);
    ...
    public void Deserialize_ValidCborData_ReturnsCorrectModel()
    {
        ...
        var cborData = NCborSerializer.Serialize(original, _context.SimpleModel);

        // Act
        var deserialized = NCborSerializer.Deserialize(cborData, _context.SimpleModel);
    ...
    public void Serialize_ModelWithAttributes_RespectsCustomPropertyNames()
    {
        ...
        // Act
        var result = NCborSerializer.Serialize(model, _context.ModelWithAttributes);
    ...
    public void Serialize_List_ReturnsValidCborArray()
    {
        ...
        // Act
        var result = NCborSerializer.Serialize(models, _context.ListOfSimpleModel);
    ...
    public void RoundTrip_List_PreservesAllItems()
    {
        ...
        // Act
        var serialized = NCborSerializer.Serialize(original, _context.ListOfSimpleModel);
        var deserialized = NCborSerializer.Deserialize(serialized, _context.ListOfSimpleModel);
    ...
    public void Serialize_AllTypesModel_HandlesAllPrimitiveTypes()
    {
        ...
        var result = NCborSerializer.Serialize(model, _context.AllTypesModel);
        result.Should().NotBeNull();
        result.Should().NotBeEmpty();

        // Verify round trip works
        var deserialized = NCborSerializer.Deserialize(result, _context.AllTypesModel);
    ...
    public void Serialize_EmptyString_HandlesCorrectly()
    {
        ...
        // Act
        var result = NCborSerializer.Serialize(model, _context.SimpleModel);
        var deserialized = NCborSerializer.Deserialize(result, _context.SimpleModel);
